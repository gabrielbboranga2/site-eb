...
export default function DashboardGate(){
 ...
 if(user===undefined)return <main className="central-loader" aria-live="polite"><div className="loader-insignia">EB</div><span className="loader-kicker">CENTRAL MILITAR</span><h1>Preparando seu posto de comando</h1><p>Validando patente, divisões e permissões.</p><div className="loader-track"><i/></div></main>;
